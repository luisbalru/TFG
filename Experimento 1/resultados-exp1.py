...
accuracy_X = np.loadtxt("./Resultados/accuracy_Xslices-d.out",delimiter=',',dtype=np.float64)
accuracy_Y = np.loadtxt("./Resultados/accuracy_Yslices-d.out",delimiter=',',dtype=np.float64)
accuracy_Z = np.loadtxt("./Resultados/accuracy_Zslices-d.out",delimiter=',',dtype=np.float64)
